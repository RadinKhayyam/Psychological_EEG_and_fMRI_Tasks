...
try
    ...
    results = zeros(numTrials, 7); % [Trial, Deck chosen, Net outcome, Response time]
    lastOutcome = 0;
    ...
    imagePath = 'img2.jpg'; % Path to your image file
    ...
    for trial = 1:numTrials
        % (Your existing trial code here...)
    
        % Display the decks and wait for the participant to choose one
        response = 0;
        ...
        while response == 0
            ...
            if keyCode(KbName('ESCAPE'))|| keyCode(KbName('e'))
                ...
                disp('Task was exited by the user.');
                return;
            end
        end
